"""
Quality Control Vision - Dataset
"""
import os
import torch
...
class QualityControlVisionDataset(Dataset):
    """Dataset for quality control vision."""
...
def get_dataloader(root, split, config):
    ...
    dataset = QualityControlVisionDataset(root, split, transform)
    return DataLoader(
        dataset,
